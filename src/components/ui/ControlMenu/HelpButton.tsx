    ...
    <ModalContent>
      {(onClose) => (
        <>
          ...
          <ModalBody>
            <p><span className="text-primary">Mobile: </span>Pinch to zoom, drag to rotate around focus.</p>
            <p><span className="text-primary">Desktop: </span>Left click + drag to move, scroll to zoom.</p>
            ...
            <p><span className="text-primary">Note: </span> Free movement and speed are disabled when zoomed in on a planet</p>
          </ModalBody>
          <ModalFooter>
