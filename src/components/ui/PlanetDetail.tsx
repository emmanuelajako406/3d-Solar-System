      ...
      {shouldDisplayDetails && (
        ...
        >
          <div className="p-4 bg-black/50 backdrop-blur-sm rounded-lg">
            ...
            <h4 className='tracking-tight text-2xl mb-5 ml-1 bg-primary text-white font-semibold'>{displayedPlanet?.displayStats.classification}</h4>
            <ul className='text-sm w-full ml-2 hidden lg:block text-gray-200'>
              <li>
                <p>
